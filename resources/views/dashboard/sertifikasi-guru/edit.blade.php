            ...
            <div class="row g-4"> <!--begin::Col-->
                ...
                <div class="col-md-6"> <!--begin::Quick Example-->
                    <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{route('db.sertifikasi.guru.update', ['id' => $data->id])}}"> <!--begin::Body-->
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="mb-3"> 
                                    ...
                                    <input type="text" name="nama" value="{{$data->nama}}" class="form-control" placeholder="Nama Sertifikat" required>
                                </div>
                                <div class="mb-3"> 
                                ...
                                <div class="mb-3"> 
                                    ...
                                    <textarea type="text" name="deskripsi" class="form-control" placeholder="Deskripsi">{{$data->deskripsi}}</textarea>
                                </div>
