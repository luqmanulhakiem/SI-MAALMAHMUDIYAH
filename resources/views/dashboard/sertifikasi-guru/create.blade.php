            ...
            <div class="row g-4"> <!--begin::Col-->
                ...
                <div class="col-md-6"> <!--begin::Quick Example-->
                    <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                        ...
                        <form method="POST" action="{{route('db.sertifikasi.guru.store')}}" enctype="multipart/form-data"> <!--begin::Body-->
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="mb-3"> 
                                    ...
                                    <input type="text" name="nama" class="form-control" placeholder="Nama Sertifikat" required>
                                </div>
                                <div class="mb-3"> 
